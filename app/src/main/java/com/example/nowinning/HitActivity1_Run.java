...
public class HitActivity1_Run extends Fragment {
    ...
    public static int hit1_run1, hit1_run2, hit1_run3, hit1_run4, hit1_run5; // 도루, 태그업, 희생 번트, 수비 에러 각각 카운터
    public static LinearLayout layout_hit1_run; // 플라이아웃 프래그 먼트
