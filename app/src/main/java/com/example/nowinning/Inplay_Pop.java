...
public class Inplay_Pop extends Fragment {

    public static Button btn_Out, btn_Hit, btn_Error, btn_Foul, btn_ItpHR, btn_Bfoul;
    private int i;
    public static LinearLayout layout_Pop;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {

        View v = inflater.inflate(R.layout.inplay_p, container, false);
        ...
        layout_Pop = (LinearLayout) v.findViewById(R.id.layout_Pop);
        ...
        btn_Out.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                btn_o.performClick();
                layout_Pop.setVisibility(View.INVISIBLE);
