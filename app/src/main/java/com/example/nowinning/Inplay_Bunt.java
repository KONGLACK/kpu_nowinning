...
public class Inplay_Bunt extends Fragment {
    ...
    private int i;
    public static LinearLayout layout_Bunt;

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {

        View v = inflater.inflate(R.layout.inplay_b, container, false);
        ...
        layout_Bunt = (LinearLayout) v.findViewById(R.id.layout_Bunt);
