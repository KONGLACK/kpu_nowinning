    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        record_button.setOnClickListener(new View.OnClickListener() { // 선수 기록
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(StartManager.this,"선수 기록을 확인할 수 있는 버튼입니다.", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(StartManager.this, StartRecorder.class);
                startActivity(intent);
        ...
        community_button.setOnClickListener(new View.OnClickListener() { // 커뮤니티
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(StartManager.this,"커뮤니티에 접근할 수 있는 버튼입니다.", Toast.LENGTH_SHORT).show();
        ...
        vs_button.setOnClickListener(new View.OnClickListener() { // 상대 전적
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(StartManager.this, StartVs.class);
                startActivity(intent);
